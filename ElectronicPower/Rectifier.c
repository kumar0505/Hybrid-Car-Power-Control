  ...
  outC_Rectifier *outC)
{
  ...
  outC->fby_3.items[outC->fby_3.idx] = V1;
  outC->fby_3.idx = (outC->fby_3.idx + 1) % 3;
  _L4 = outC->fby_4.items[outC->fby_4.idx];
  outC->fby_4.items[outC->fby_4.idx] = V2;
  ...
  outC->fby_1.items[outC->fby_1.idx] = V2;
  outC->fby_1.idx = (outC->fby_1.idx + 1) % 5;
  _L5 = outC->fby_2.items[outC->fby_2.idx];
  outC->fby_2.items[outC->fby_2.idx] = V3;
  outC->fby_2.idx = (outC->fby_2.idx + 1) % 4;
  _L9 = /* _L9=(math::Max3#1)/ */ Max3_math_float32(V1, _L4, _L5);
  /* @1/_L4= */
  if (_L9 >= _L10) {
